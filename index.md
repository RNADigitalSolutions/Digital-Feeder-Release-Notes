## ✨ Digital Feeder 1.10.4  &nbsp;[<i class="fas fa-download fa-xs"></i>]()
<i class="far fa-calendar-alt"></i> &nbsp; xx.02.2022

### New Feature
- Camera dash board: control camera speed, position, view center and up vector, save and load camera states in .dfs file
- <kbd>W</kbd> <kbd>A</kbd> <kbd>S</kbd> <kbd>D</kbd> und <kbd>↑</kbd> <kbd>←</kbd> <kbd>↓</kbd> <kbd>→</kbd> to move camera
